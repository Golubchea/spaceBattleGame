...
if(CODE_COVERAGE AND NOT CODE_COVERAGE_ADDED)
  ...
  if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang"
    ...
    if(NOT LLVM_COV_PATH)
      message( "llvm-cov not found! Aborting.")
  ...
  elseif(CMAKE_C_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES
    ...
    if(NOT LCOV_PATH)
      ...
      set (CODE_COVERAGE OFF)
      message(  "lcov not found! Aborting...")
    endif()

 
    if(NOT GENHTML_PATH)
         set (CODE_COVERAGE OFF)
      message( "genhtml not found! Aborting...")
    endif()
    ...
    add_custom_target(ccov-clean COMMAND ${LCOV_PATH} --directory
       ...
       set (CODE_COVERAGE OFF)
    message(  "Code coverage requires Clang or GCC. Aborting.")
  endif()
endif()
